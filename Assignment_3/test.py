...
def spam_or_non_spam_tester(score_function_unittest_instance: TestScoreFunction, message: str, is_spam: bool):
    ...
    prediction, _ = score(message, score_function_unittest_instance.model, score_function_unittest_instance.vectorizer,
                          score_function_unittest_instance.threshold)
    if is_spam:
...
class TestFlaskApp(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.flask_process = subprocess.Popen([r"C:\\Users\\chaud\\AppData\\Local\\Programs\\Python\\Python311\\python.exe", "app.py"])
